    ...
    <div className={own ? "message own" : "message"}>
      <div className="messageTop">
        ...
        <p className="messageText">
          ...
          adipisicing elit. Illo totam voluptatibus vel eveniet distinctio nam.
          Ex, perspiciatis nesciunt sunt enim ratione, dolores id accusamus
          impedit aliquid officiis ab officia assumenda?
        </p>
      </div>
